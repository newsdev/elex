...
#. Fork the project on `Github <https://github.com/newsdev/nyt-ap-elections>`_.
#. Install a development version of the code with ``pip install -e git+git@github.com:<YOUR_GITHUB_USER>/nyt-ap-elections#egg=nyt-ap-elections`` 
#. Check out the `issue tracker <https://github.com/newsdev/nyt-ap-elections/issues>`_ and pick out a task or create a new issue 
...
#. Make sure all tests are passing by running ``nosetests tests``
