    ...
    def test_candidate_reporting_unit_serialization_order(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                'polnum', 'precinctsreporting', 'precinctsreportingpct',
                'precinctstotal', 'reportingunitid', 'reportingunitname',
                'runoff', 'seatname', 'seatnum', 'statename', 'statepostal',
                'test', 'uncontested', 'votecount', 'votepct', 'winner'
            ]
        )
